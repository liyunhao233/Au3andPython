...
While 1
	...
	Else
			...
			CopyExcel($car,$chair,$shape,$A,$B,$C) ;车厂名-座椅厂-车型-芯片-左右驾-多少排
...
$xlsxpath='\\192.168.2.100\100\版本迭代\'&GUICtrlRead($aa)&'_'&GUICtrlRead($bb)&'_'&GUICtrlRead($cc)&'_'&$f&$d&'_'&$e&'\'&'V000'&'-'&$timestamp&'_施工中'&'\'&'V000_'&$timestamp&'_A13Calc_施工中'&'.xlsx'
ShellExecute("D:\PythonCode\demo0117\dist\dist\0131CreatePoj\0131CreatePoj.exe",$car1&'_'&$chair1&'_'&$shape1&'_'&$A&'_'&$B&'_'&$C&'>'&$xlsxpath'>'$codeandid)  
...
Func CopyExcel($aa,$bb,$cc,$d,$e,$f) ;车厂名-座椅厂-车型-芯片-左右驾-多少排
	Local $timestamp=@YEAR&@MON&@MDAY&@HOUR&@MIN
